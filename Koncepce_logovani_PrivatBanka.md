...
4.  **Onboarding:** Výsledek liveness testu (ZenID), výsledek AML kontroly v Centrisu, podpis smlouvy.
...
*   **Database Audit Trail:** Transakční logy core systému Centris/STORM.
...
*   **Service Load:** Vytížení systému ZenID a Centris v reálném čase.
